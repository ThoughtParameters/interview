...
const LearnPage=()=>{const data=(0,gatsby__WEBPACK_IMPORTED_MODULE_1__.useStaticQuery)("2075359023");const ckaTopics=data.allMarkdownRemark.edges.filter(({node})=>node.fileAbsolutePath.includes('/cka/'));const ckadTopics=data.allMarkdownRemark.edges.filter(({node})=>node.fileAbsolutePath.includes('/ckad/'));return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_layout__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z,null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_seo__WEBPACK_IMPORTED_MODULE_3__/* .SEO */ .H,{title:"Learn"}),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1",{className:"text-3xl font-bold mb-4"},"Learning Topics"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-8"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h2",{className:"text-2xl font-bold mb-4"},"CKA Topics"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("ul",{className:"list-disc pl-5"},ckaTopics.map(({node})=>/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li",{key:node.frontmatter.slug,className:"mb-2"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby__WEBPACK_IMPORTED_MODULE_1__.Link,{to:`/learn/${node.frontmatter.slug}`,className:"text-blue-400 hover:underline"},node.frontmatter.title))))),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h2",{className:"text-2xl font-bold mb-4"},"CKAD Topics"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("ul",{className:"list-disc pl-5"},ckadTopics.map(({node})=>/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li",{key:node.frontmatter.slug,className:"mb-2"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby__WEBPACK_IMPORTED_MODULE_1__.Link,{to:`/learn/${node.frontmatter.slug}`,className:"text-blue-400 hover:underline"},node.frontmatter.title)))))));};/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (LearnPage);

/***/ })

};
;
//# sourceMappingURL=component---src-pages-learn-index-js.js.map