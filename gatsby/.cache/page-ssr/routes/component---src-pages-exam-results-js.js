...
/* harmony import */ var _reach_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(7896);
...
const ExamResultsPage=()=>{const location=(0,_reach_router__WEBPACK_IMPORTED_MODULE_1__.useLocation)();const{score,passed,verificationId}=location.state||{};return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_layout__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z,null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_seo__WEBPACK_IMPORTED_MODULE_3__/* .SEO */ .H,{title:"Exam Results"}),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1",{className:"text-3xl font-bold mb-4"},"Exam Results"),location.state?/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{className:"bg-gray-800 p-6 rounded-lg"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h2",{className:"text-2xl font-bold mb-2"},"You ",passed?'Passed!':'Did Not Pass'),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("strong",null,"Your Score:")," ",score,"%"),passed&&/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p",null,"Congratulations! You can view your certificate here:"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a",{href:`/verify/${verificationId}`,className:"text-blue-400 hover:underline"},"View Certificate"))):/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p",null,"No exam results to display."));};/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ExamResultsPage);

/***/ })

};
;
//# sourceMappingURL=component---src-pages-exam-results-js.js.map