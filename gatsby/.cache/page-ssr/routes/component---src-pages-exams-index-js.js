...
/* harmony import */ var _utils_supabase__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(7711);
const ExamsPage=()=>{const{0:exams,1:setExams}=(0,react__WEBPACK_IMPORTED_MODULE_0__.useState)([]);const{0:loading,1:setLoading}=(0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(true);const{0:error,1:setError}=(0,react__WEBPACK_IMPORTED_MODULE_0__.useState)('');(0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(()=>{const fetchExams=async()=>{const supabase=(0,_utils_supabase__WEBPACK_IMPORTED_MODULE_4__/* .getSupabase */ .S)();const{data,error}=await supabase.from('exams').select('*');if(error){setError(error.message);}else{setExams(data);}setLoading(false);};fetchExams();},[]);return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_layout__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z,null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_seo__WEBPACK_IMPORTED_MODULE_3__/* .SEO */ .H,{title:"Exams"}),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1",{className:"text-3xl font-bold mb-6"},"Available Exams"),loading&&/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p",null,"Loading exams..."),error&&/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p",{className:"text-red-500"},error),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-8"},exams.map(exam=>/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby__WEBPACK_IMPORTED_MODULE_1__.Link,{key:exam.slug,to:`/exams/${exam.slug}`,className:"block p-6 bg-gray-800 rounded-lg hover:bg-gray-700 transition-colors"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h2",{className:"text-2xl font-bold mb-2"},exam.name),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p",null,exam.description)))));};/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ExamsPage);

/***/ })

};
;
//# sourceMappingURL=component---src-pages-exams-index-js.js.map