...
const examData={cka:{title:'Certified Kubernetes Administrator (CKA)',description:'The CKA certification is for Kubernetes administrators, cloud administrators, and other IT professionals who manage Kubernetes instances.',domains:[{name:'Cluster Architecture, Installation & Configuration',weight:'25%'},{name:'Workloads & Scheduling',weight:'15%'},{name:'Services & Networking',weight:'20%'},{name:'Storage',weight:'10%'},{name:'Troubleshooting',weight:'30%'}]},ckad:{title:'Certified Kubernetes Application Developer (CKAD)',description:'The CKAD certification is for Kubernetes engineers, cloud engineers, and other IT professionals responsible for building, deploying, and configuring cloud-native applications with Kubernetes.',domains:[{name:'Application Design and Build',weight:'20%'},{name:'Application Deployment',weight:'20%'},{name:'Application Environment, Configuration, and Security',weight:'25%'},{name:'Application Observability and Maintenance',weight:'15%'},{name:'Services and Networking',weight:'20%'}]}};const ExamInfoPage=()=>{return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_layout__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z,null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_seo__WEBPACK_IMPORTED_MODULE_2__/* .SEO */ .H,{title:"Exam Information"}),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1",{className:"text-3xl font-bold mb-6"},"Exam Information"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{className:"space-y-12"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(ExamSection,{exam:examData.cka}),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(ExamSection,{exam:examData.ckad})));};const ExamSection=({exam})=>/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("section",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h2",{className:"text-2xl font-bold mb-4"},exam.title),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p",{className:"mb-4"},exam.description),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{className:"overflow-x-auto"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("table",{className:"min-w-full bg-gray-800 rounded-lg"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("thead",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("tr",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("th",{className:"px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider"},"Domain"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("th",{className:"px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider"},"Weight"))),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("tbody",{className:"divide-y divide-gray-700"},exam.domains.map(domain=>/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("tr",{key:domain.name},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("td",{className:"px-6 py-4 whitespace-nowrap"},domain.name),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("td",{className:"px-6 py-4 whitespace-nowrap"},domain.weight)))))));/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ExamInfoPage);

/***/ })

};
;
//# sourceMappingURL=component---src-pages-exam-info-js.js.map